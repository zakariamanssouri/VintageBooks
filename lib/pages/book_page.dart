            ...
            children: [
              Container(
                ...
                child: TabBar(
                  ...
                  tabs: [
                    Text("Nouveaux Livres", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),),
                    Text("Livres Populaires", style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500),),
                  ],
                ),
              ),
              Expanded(
